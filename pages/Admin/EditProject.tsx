...
const EditProject: React.FC = () => {
   ...
   const [jenjang, setJenjang] = useState<EducationLevel>('MI');
   ...
   useEffect(() => {
      const loadData = async () => {
         try {
            ...
            setFakultas(project.fakultas || '');
            setJurusan(project.jurusan || '');
            setLingkupKampus(project.fakultas ? 'Spesifik' : 'Umum');
